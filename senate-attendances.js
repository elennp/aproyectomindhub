...
let list_least_engaged=document.getElementById('senate_least_engaged');
let list_most_engaged=document.getElementById('senate_most_engaged');
...
function getDocument() {
  paintTable(senate_statics, 'democrat', 'democrats_average_party', democratTable)
  paintTable(senate_statics, 'republican', 'republicans_average_party', republicTable)
  paintTable(senate_statics, 'independent', 'independents_average_party', independentTable)
...
createListEngaged(senate_statics.least_engaged,list_least_engaged,"missed_votes","missed_votes_pct")
createListEngaged(senate_statics.most_engaged,list_most_engaged,"missed_votes","missed_votes_pct")
